      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
            <?php
                ...
                $quary ="SELECT * FROM settings WHERE schoolId = 2";
                $s_name = mysqli_query($connection,$quary);
                $result = mysqli_fetch_assoc($s_name);
            ?>
            <div class="site-logo mr-auto w-25"><a href="index.html"><?php  echo $result['schoolName']  ;  ?></a></div>
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="login.php" class="nav-link"><span>تسجيل الدخول</span></a></li>
              </ul>
            </nav>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <p class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200"><?php echo $result['schoolAddress']; ?></p>
                  <p class="mb-4"  data-aos="fade-up" data-aos-delay="200"><?php echo $result['schoolPhone']; ?></p>
                    <h3  data-aos="fade-up" data-aos-delay="100"><?php echo $result['schoolBlog']; ?></h3>
              </p>
              </div>
